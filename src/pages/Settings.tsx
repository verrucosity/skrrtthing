    ...
    >
      <div className="space-y-4">
        <p className="text-xs text-zinc-500">
          ...
          the Saturday 7pm to Sunday 7pm PT window it switches over to the Saturday goal, then
        ...
        <p className="text-xs text-zinc-500">
          ...
          {inWindow ? (
            ...
            <span className="ml-2 text-zinc-600">(showing weekly goal, Saturday takes over at 7pm PT)</span>
          )}
        </p>
